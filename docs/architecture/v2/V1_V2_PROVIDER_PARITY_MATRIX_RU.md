...
| Meta Business discovery            | `meta_ads/graph_read.py`                         | `/me/businesses`                                                            | IMPLEMENTED | live read pending                            |
...
| Meta campaigns                     | `meta_ads/account_read.py`                       | `/{ad-account}/campaigns`                                                   | IMPLEMENTED | live read pending                            |
| Meta metrics                       | `meta_ads/analysis.py`                           | `/{ad-account}/insights`                                                    | IMPLEMENTED | live read pending                            |
