# HolyMedia MCP — roadmap русификации, регистрации, клиентской панели, админки и базы данных

## 1. Контекст проекта

HolyMedia MCP — hosted MCP-сервис для подключения рекламных кабинетов к AI-клиентам: Codex, Claude и другим MCP-compatible инструментам.
...
- Обратитесь к менеджеру HolyMedia.
...
- Войти;
- Зарегистрироваться;
- короткое объяснение, что такое HolyMedia MCP.
...
- Вход в HolyMedia MCP;
- Email;
- Пароль;
- Войти;
- Нет аккаунта? Зарегистрироваться;
- Забыли пароль? Напишите менеджеру HolyMedia.
