...
- сравнение с предыдущим периодом с абсолютным и процентным изменением
  расхода, трафика и конверсий; для MCP report skill предыдущий период
  формируется автоматически равной длины;
...
Следующий report block: async artifact storage, затем PDF после выбора и
проверки production-grade PDF renderer.
