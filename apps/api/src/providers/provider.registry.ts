...
} from "./adapters/google.analytics.js";
...
export class ProviderRegistry {
  ...
  public constructor() {
    ...
    const analytics = new GoogleAnalyticsAdapter(this.config);
    this.entries = [
      {
      ...
      {
        definition: googleAnalyticsDefinition(
          analytics.definition.status === "available",
        ),
        adapter: analytics,
      },
      {
