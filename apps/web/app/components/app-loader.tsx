...
export function AppLoader() {
  ...
  useEffect(() => {
    ...
    const finish = () => {
      const remaining = Math.max(
        0,
        MINIMUM_LOADER_DURATION - (performance.now() - startedAt),
      );
  ...
  return (
    <div
      className={`app-loader${visible ? "" : " app-loader--hidden"}`}
      aria-hidden="true"
      ...
      <div className="app-loader__mark">
        <svg viewBox="0 0 108 112" aria-hidden="true">
          <path
            ...
            d="M7 29c11 3 17 10 25 7 8-3 10-13 7-21"
          />
          <path
            className="app-loader__stream app-loader__stream--center"
            d="M54 5c-5 9-3 18 4 22 7 4 11-5 7-14"
          />
          <path
            className="app-loader__stream app-loader__stream--right"
            d="M101 29c-11 3-17 10-25 7-8-3-10-13-7-21"
          />
          <path
            className="app-loader__channel"
