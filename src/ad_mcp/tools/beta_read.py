...
def _normalize_metric_row(platform: str, account_id: str, row: dict[str, Any]) -> dict[str, Any]:
    ...
    normalized: dict[str, Any] = {
        ...
        "ad_group_id": row.get("ad_group_id") or row.get("adset_id"),
        "ad_group_name": row.get("ad_group_name") or row.get("adset_name") or row.get("ad_group"),
        "ad_id": row.get("ad_id"),
        "ad_name": row.get("ad_name") or row.get("ad"),
